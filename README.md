...
(338 assertions from a clean clone; 699 when the manuscript's `numbers.tex` is also present).
...
it additionally cross-checks every macro against its source and the manuscript prose, and reports 699.
