...
(322 assertions from a clean clone; 674 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 322 claims, values and semantics alike, and exits non-zero on
