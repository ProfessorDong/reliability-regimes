...
(302 assertions from a clean clone; 566 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 302 claims, values and semantics alike, and exits non-zero on
