...
(240 assertions from a clean clone; 475 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 240 claims, values and semantics alike, and exits non-zero on
