...
Writes ecfp_baseline.json.
    ...
    python -m world_model.run_ecfp_baseline_v1 --seeds 25
"""
...
from world_model.oracle import load_target_data, featurize  # noqa: E402
...
class ECFPSurrogate:
    """Online ECFP random-forest surrogate; same interface as LatentWorldModel."""
...
def main():
    ...
    for target in args.targets:
        ...
        for seed in range(args.seeds):
            ...
            g = WMGuidedGA(target, rw, world_model=wm, mode='wm', beta=0.0, seed=seed); g.run(seeds, BUDGET)
