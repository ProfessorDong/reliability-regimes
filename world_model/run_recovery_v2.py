...
recovery_v2_results.json.
    ...
    python -m world_model.run_recovery_v2 --seeds 3
"""
...
from world_model.oracle import load_target_data, featurize, _ensemble_preds  # noqa: E402
...
from world_model.run_ecfp_baseline_v1 import ECFPSurrogate  # noqa: E402
from world_model.run_fewshot_v1 import OUT_DIR  # noqa: E402
...
def run_search(method, target, reward, seeds):
    if method == 'graphga':
        ...
        g = WMGuidedGA(target, reward, world_model=None, mode='randtriage', seed=0)
    else:
        g = WMGuidedGA(target, reward, world_model=ECFPSurrogate(seed=0), mode='wm', beta=0.0, seed=0)
    g.run(seeds, BUDGET)
    return g
    ...
    for target in args.targets:
        ...
        for ci, cl in enumerate(clusters):
            ...
            for seed in range(args.seeds):
                ...
                for m in rec:
                    rw = CWMReward(target, anti_targets=(), lambda_unc=0.1, weights=cfg_w)
