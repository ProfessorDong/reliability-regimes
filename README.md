...
(263 assertions from a clean clone; 500 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 263 claims, values and semantics alike, and exits non-zero on
