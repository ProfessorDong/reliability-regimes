...
(226 assertions from a clean clone; 459 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 226 claims, values and semantics alike, and exits non-zero on
