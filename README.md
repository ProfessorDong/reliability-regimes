...
(316 assertions from a clean clone; 632 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 316 claims, values and semantics alike, and exits non-zero on
