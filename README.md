...
(211 assertions from a clean clone; 444 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 211 claims, values and semantics alike, and exits non-zero on
