...
(180 assertions from a clean clone; 330 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 180 claims, values and semantics alike, and exits non-zero on
