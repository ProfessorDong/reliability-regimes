...
(179 assertions from a clean clone; 327 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 179 claims, values and semantics alike, and exits non-zero on
