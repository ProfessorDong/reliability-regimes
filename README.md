...
(318 assertions from a clean clone; 666 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 318 claims, values and semantics alike, and exits non-zero on
