...
(293 assertions from a clean clone; 530 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 293 claims, values and semantics alike, and exits non-zero on
