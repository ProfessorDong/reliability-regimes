...
Writes reliability_analysis.json.
    ...
    python -m world_model.run_reliability_v1
"""
...
from world_model.oracle import TARGETS, load_target_data, featurize  # noqa: E402
from world_model.run_applicability_v1 import max_tanimoto_to_set, partial_spearman  # noqa: E402

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(BASE, 'outputs', 'cwm_v1', 'reliability_analysis.json')
