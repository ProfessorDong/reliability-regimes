...
(221 assertions from a clean clone; 454 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 221 claims, values and semantics alike, and exits non-zero on
