...
(269 assertions from a clean clone; 506 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 269 claims, values and semantics alike, and exits non-zero on
