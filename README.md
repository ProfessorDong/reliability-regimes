...
(256 assertions from a clean clone; 493 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 256 claims, values and semantics alike, and exits non-zero on
