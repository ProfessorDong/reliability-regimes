...
Writes outputs/cwm_v1/compat_gen_analysis.json.

    python -m world_model.analyze_compat_gen
"""
...
SRC = os.path.join(BASE, 'outputs', 'cwm_v1', 'compat_gen_results.json')
OUT = os.path.join(BASE, 'outputs', 'cwm_v1', 'compat_gen_analysis.json')
