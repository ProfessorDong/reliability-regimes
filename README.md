...
(192 assertions from a clean clone; 425 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 192 claims, values and semantics alike, and exits non-zero on
