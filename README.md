...
(174 assertions from a clean clone; 317 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 174 claims, values and semantics alike, and exits non-zero on
