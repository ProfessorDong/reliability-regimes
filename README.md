...
(231 assertions from a clean clone; 466 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 231 claims, values and semantics alike, and exits non-zero on
