...
(300 assertions from a clean clone; 550 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 300 claims, values and semantics alike, and exits non-zero on
