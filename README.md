...
(216 assertions from a clean clone; 449 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 216 claims, values and semantics alike, and exits non-zero on
