...
(317 assertions from a clean clone; 638 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 317 claims, values and semantics alike, and exits non-zero on
