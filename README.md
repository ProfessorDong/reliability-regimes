...
(182 assertions from a clean clone; 334 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 182 claims, values and semantics alike, and exits non-zero on
