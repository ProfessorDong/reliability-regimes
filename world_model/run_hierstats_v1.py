...
Writes hierstats_analysis.json.
    ...
    python -m world_model.run_hierstats_v1
"""
...
OUT = os.path.join(BASE, 'outputs', 'cwm_v1', 'hierstats_analysis.json')
TARGETS = ['scd1', 'fads', 'nk1r', 'drd2', 'drd3']


def load_paired():
    W = json.load(open(os.path.join(BASE, 'outputs/cwm_v1/wmga_results.json')))['results']
    G = json.load(open(os.path.join(BASE, 'outputs/cwm_v1/graphga_results.json')))['results']
