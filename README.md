...
(177 assertions from a clean clone; 323 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 177 claims, values and semantics alike, and exits non-zero on
