...
(298 assertions from a clean clone; 535 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 298 claims, values and semantics alike, and exits non-zero on
