...
Potency comes from the frozen RF-on-ECFP oracle (world_model.oracle). The
...
Smoke test:
    python -m world_model.reward --target drd3 --anti drd2
"""
...
from world_model.oracle import (  # noqa: E402
...
if __name__ == '__main__':
    ...
    rw = CWMReward(args.target, anti_targets=args.anti, lambda_unc=0.1,
