...
(172 assertions from a clean clone; 309 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 172 claims, values and semantics alike, and exits non-zero on
