...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21874305.svg)](https://doi.org/10.5281/zenodo.21874305)

Archived at release `v1.3-npjdd-submission`: [10.5281/zenodo.21874305](https://doi.org/10.5281/zenodo.21874305). Cite that DOI rather than the repository URL, which is mutable. [10.5281/zenodo.21864875](https://doi.org/10.5281/zenodo.21864875) resolves to all versions.
...
(352 assertions from a clean clone; 729 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 352 claims, values and semantics alike, and exits non-zero on
any mismatch. It runs from a clean clone; with the manuscript's `numbers.tex` also present
it additionally cross-checks every macro against its source and the manuscript prose, and reports 729.
