...
Writes mixedmodel_method.json.
    ...
    python -m reliability.run_mixedmodel_method
"""
...
SRC = os.path.join(BASE, 'outputs', 'frozen', 'methods_v2_results.json')
OUT = os.path.join(BASE, 'outputs', 'frozen', 'mixedmodel_method.json')
