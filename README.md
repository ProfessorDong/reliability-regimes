...
(309 assertions from a clean clone; 625 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 309 claims, values and semantics alike, and exits non-zero on
