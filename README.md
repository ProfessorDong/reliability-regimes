...
(288 assertions from a clean clone; 525 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 288 claims, values and semantics alike, and exits non-zero on
