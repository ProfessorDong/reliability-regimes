...
Fully CPU (no dual encoder). Writes methods_v2_results.json.
    ...
    python -m reliability.run_methods_v2 --seeds 25
"""
...
from reliability.run_ecfp_baseline_v1 import ECFPSurrogate, top10_novel  # noqa: E402
...
def run_cell(target, k, seed, actives, train_canon, cfg):
    ...
    rw = TargetReward(target, anti_targets=cfg['anti'], lambda_unc=LAMBDA_UNC, weights=cfg['weights'])
    g = SurrogateTriagedGA(target, rw, surrogate=None, mode='randtriage', seed=seed)
