...
(275 assertions from a clean clone; 512 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 275 claims, values and semantics alike, and exits non-zero on
