...
mutation is atom/bond-level. It uses the SAME CWMReward oracle, the SAME k-seed
...
Exposes run(seed_smiles, budget) -> results with the same shape as Planner.results().
    ...
    python -m world_model.graph_ga --target drd3 --budget 300
"""
...
from world_model.actions import _attach, _canon, _dummy_atoms  # reuse fragment-join helpers
