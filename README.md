...
(305 assertions from a clean clone; 626 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 305 claims, values and semantics alike, and exits non-zero on
