...
(245 assertions from a clean clone; 480 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 245 claims, values and semantics alike, and exits non-zero on
