...
(154 assertions from a clean clone; 265 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 154 claims, values and semantics alike, and exits non-zero on
