...
(208 assertions from a clean clone; 441 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 208 claims, values and semantics alike, and exits non-zero on
