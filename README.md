...
(178 assertions from a clean clone; 324 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 178 claims, values and semantics alike, and exits non-zero on
