...
Loads outputs/frozen/frontier_v1_results.json (the 5-target x 25-seed x novelty
...
Writes outputs/frozen/frontier_analysis.json (frozen numbers for the manuscript).

    python -m reliability.analyze_frontier
"""
...
SRC = os.path.join(BASE, 'outputs', 'frozen', 'frontier_v1_results.json')
OUT = os.path.join(BASE, 'outputs', 'frozen', 'frontier_analysis.json')
