...
(251 assertions from a clean clone; 488 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 251 claims, values and semantics alike, and exits non-zero on
