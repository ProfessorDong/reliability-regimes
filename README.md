...
(163 assertions from a clean clone; 298 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 163 claims, values and semantics alike, and exits non-zero on
