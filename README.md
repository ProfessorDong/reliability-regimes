...
(281 assertions from a clean clone; 518 when the manuscript's `numbers.tex` is also present).
...
`verify_results.py` asserts 281 claims, values and semantics alike, and exits non-zero on
